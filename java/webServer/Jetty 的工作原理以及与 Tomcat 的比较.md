...
##### 图 1. Jetty 的基本架构
![Jetty 的基本架构](https://www.ibm.com/developerworks/cn/java/j-lo-jetty/image003.jpg)


Jetty 中还有一些可有可无的组件，我们可以在它上做扩展。如 JMX，我们可以定义一些 Mbean 把它加到 Server 中，当 Server 启动的时候，这些 Bean 就会一起工作。

##### 图 2. Jetty 的主要组件的类图
![ Jetty 的主要组件的类图](https://www.ibm.com/developerworks/cn/java/j-lo-jetty/image005.jpg)
...
![Handler 的体系结构](https://www.ibm.com/developerworks/cn/java/j-lo-jetty/image008.png)
...
![Jetty 的启动流程](https://www.ibm.com/developerworks/cn/java/j-lo-jetty/image011.jpg)
...
![建立连接的时序图](https://www.ibm.com/developerworks/cn/java/j-lo-jetty/image011.jpg)
...
![处理连接时序图](https://www.ibm.com/developerworks/cn/java/j-lo-jetty/image013.jpg)
...
![Web 服务端架构](https://www.ibm.com/developerworks/cn/java/j-lo-jetty/image017.jpg)
...
SelectionKey key = ssc.register( selector, SelectionKey.OP_ACCEPT ); ServerSocketChannel ss = (ServerSocketChannel)key.channel(); 
...
ContextHandler context = new ContextHandler(); context.setContextPath("/"); 
context.setResourceBase("."); context.setClassLoader(Thread.currentThread().getContextClassLoader()); server.setHandler(context);
...
ServletContextHandler root = new ServletContextHandler(null,"/",ServletContextHandler.SESSIONS); server.setHandler(root); 
...
##### 图 8. Jetty 处理请求的时序图
![ Jetty 处理请求的时序图](https://www.ibm.com/developerworks/cn/java/j-lo-jetty/image025.jpg)
...
##### 图 9. jboss-jetty 目录
![ jboss-jetty 目录](https://www.ibm.com/developerworks/cn/java/j-lo-jetty/image027.jpg)
